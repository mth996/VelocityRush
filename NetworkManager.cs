...
public class NetworkManager : MonoBehaviourPunCallbacks
{
	...
	public RacingPlayer[] DriftRacingPlayers;
	public RacingPlayer[] RacingPlayers;
    public RacingPlayer[] SprintRacingPlayers;
    public RacingPlayer[] LakeRacingPlayers;
	...
	public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey("gm"))
        {
			...
			if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("rc"))
            {
                ...
                {
                    PlayerSelectionUIGameObjects[i].transform.Find("PlayerName").GetComponent<Text>().text = DriftRacingPlayers[i].playerName;
                    PlayerSelectionUIGameObjects[i].GetComponent<Image>().sprite = DriftRacingPlayers[i].playerSprite;
            ...
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("lr"))
            {
                ...
                for (int i = 0; i < PlayerSelectionUIGameObjects.Length; i++)
                {
                    PlayerSelectionUIGameObjects[i].transform.Find("PlayerName").GetComponent<Text>().text = LakeRacingPlayers[i].playerName;
                    PlayerSelectionUIGameObjects[i].GetComponent<Image>().sprite = LakeRacingPlayers[i].playerSprite;
                    PlayerSelectionUIGameObjects[i].transform.Find("PlayerProperty").GetComponent<Text>().text = "";
                }
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("sr"))
            {
                ...
                for (int i = 0; i < PlayerSelectionUIGameObjects.Length; i++)
                {
                    PlayerSelectionUIGameObjects[i].transform.Find("PlayerName").GetComponent<Text>().text = SprintRacingPlayers[i].playerName;
                    PlayerSelectionUIGameObjects[i].GetComponent<Image>().sprite = SprintRacingPlayers[i].playerSprite;
                    PlayerSelectionUIGameObjects[i].transform.Find("PlayerProperty").GetComponent<Text>().text = "";
                }
            }
